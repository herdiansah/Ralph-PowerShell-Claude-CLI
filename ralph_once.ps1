...
- If tasks remain [ ], just end your response (next iteration will continue)" | Tee-Object -Variable currentOutput

$result = $currentOutput -join "`n"
